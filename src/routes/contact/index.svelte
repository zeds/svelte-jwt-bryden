...
<style>
/*https://www.youtube.com/watch?v=3AK3vspZvvM*/
...
.container .box textarea:focus,
.container .box textarea:valid{
	padding: 10px 10px;
	/*background: rgb(40,205,245);*/
	margin-top: 10px;
}

.container .box textarea:focus ~ label,
.container .box textarea:valid ~ label{
	padding: 0;
}
